 ...
 */
export async function generateVideo({ prompt, model, aspectRatio = '16:9', duration, apiKey }) {
 ...
 */
export async function optimize(inputPath, slug) {
  ...
  console.log(`[optimize] ${slug}.webm (VP9, CRF 34)`);
  ...
  console.log(`[optimize] ${slug}-poster.jpg`);
